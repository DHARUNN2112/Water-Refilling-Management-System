...
<html lang="en" class="html">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="profile.php"></a><a class="nav-link" href="profile.php"><i class="fas fa-user"></i><span>Profile</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="table.php"><i class="fa fa-th-list"></i><span>Purchase History</span></a><a class="nav-link  active" href="card.php"><i class="fas fa-user"></i><span>Card&nbsp;</span></a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
  ...
  <!-- Card Form -->
  <br><br>
        <form class="card-form" action="addcard.php" method="post">
          <div  class="field">
            ...
            <input id="card-number" class="field__input" type='text' name='card_no' placeholder='1234 5678 9123 4567' maxlength="20"/>
          </div>
          <div class="field field--space">
            ...
            <input id="expires-month" class="field__input field__input--cardexp-1" type="tel" name="month" placeholder="MM" allowed-pattern="[0-9]"  maxlength="2"/>
            <svg version="1.1" class="card-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 600.112 600.111" style="enable-background:new 0 0 600.112 600.111;" xml:space="preserve">
              <g>
                <g>
                  <g>
            ...
            <input id="expires-year" class="field__input field__input--cardexp-2" type="tel" name="year" placeholder="YY" allowed-pattern="[0-9]" maxlength="2"/>
          </div>
          <div class="field">
            <svg version="1.1" class="card-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
              <g transform="translate(1 1)">
            ...
            <input id="card-cvc" class="field__input field__input--cardcvc" type="tel" name="cvv" placeholder="123" maxlength="3" autocomplete="off"/>
          </div>
          <div  class="field">
            <svg version="1.1" class="card-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
              <g transform="translate(1 1)">
            ...
            <input id="name" class="field__input" type='text' name='name' placeholder='Name' maxlength="20"/>
          </div>
