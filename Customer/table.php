...
<?php
    ...
    $p_id=$_SESSION['p_id'];
    $sql = "SELECT * FROM purchase_history WHERE P_ID='$p_id';";
?>
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="table.php"><i class="fa fa-th-list"></i><span>Purchase History</span></a><a class="nav-link" href="card.php"><i class="fas fa-user"></i><span>Card&nbsp;</span></a>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    if($query_run=mysqli_query($connect,$sql)){
                                        if(mysqli_num_rows($query_run) > 0){
                                            ...
                                            echo'<div class="text-dark mb-4" align=center;>No Purchases<div>';
                                        }}
                                    ?>
                                    <tfoot>
                                        <tr>
