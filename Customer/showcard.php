...
<?php
    ...
    $p_id=$_SESSION['p_id'];
    $sql = "SELECT * FROM card_details WHERE P_ID='$p_id';";
?>
<style>
...
echo'
  <a href="card.php" class="btn-track" align=center;">
  <div class="--icon">
  ...
  <div class="--text">Add New Card</div>
    ...
    <div class="card">
      <div class="flip">
        <div class="front">
          ...
          <div class="card-number"> 
            <div class="section">'.substr("$card_no",0,4).'</div>
            <div class="section">'.substr("$card_no",5,4).'</div>
            <div class="section">'.substr("$card_no",10,4).'</div>
            <div class="section">'.substr("$card_no",15,4).'</div>
          </div>
          <div class="end"><span class="end-text">exp. end:</span><span class="end-date"> '.$row["ExpMonth"].'/'.$row["ExpYear"].'</span></div>
          <div class="card-holder">'.$row["Card_Name"].'</div>
          <div class="master">
        ...
        <div class="back">
          ...
          <div class="terms">
            <p>This card is property of Monzo Bank, Wonderland. Misuse is criminal offence. If found, please return to Monzo Bank or to the nearest bank</p>
      ...
      <a href="checkout.php" class="btn-track" align=center;">
  <div class="--icon">
    <div class="circle-inner"></div>
    <div class="circle-outer"></div>
    <svg width="24" height="24" viewBox="0 0 24 24" id="box">
  ...
  <div class="--text">Proceed To Checkpoint</div>
</a></center>
    ';
    }
}
